  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        {/* Logo */}
        <a href="#" className="flex items-center gap-2 group" aria-label="Raydesite Home">
          <div className="relative">
            <div className="w-8 h-8 bg-[#1A1A1A] rounded-sm flex items-center justify-center group-hover:bg-[#F5A623] transition-colors duration-200">
              <span className="text-[#F4F3F0] font-mono font-bold text-sm group-hover:text-[#1A1A1A] transition-colors">R</span>
            </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#F4F3F0] border-t-2 border-[#1A1A1A] px-6 py-6">
          ...
          <div className="flex gap-3">
            <a href="#register" className="flex-1 text-center font-mono text-xs font-bold uppercase tracking-widest border-2 border-[#1A1A1A] px-4 py-2 rounded-full">Register</a>
            <a href="#bag" className="flex-1 text-center font-mono text-xs font-bold uppercase tracking-widest bg-[#F5A623] border-2 border-[#1A1A1A] px-4 py-2 rounded-full">My Bag</a>
          </div>
        </div>
      )}
    </header>
